...
for (var i = 0; i < index.length; i++) {
    ...
    if (index[i] === "shopping_cart") {
        ...
        function forEachFunction(item, index) {
            ...
            dataProduct.append("id", item.idProduct);
            var price = 0;
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $(".bodyCart").append(
                            ...
                            '<td class="p-price first-row"><p class="priceShoppingCart">MXN $<span>' + Number(price).toFixed(2) + '</span></p></td>' +
                            ...
                            '</div>' +
                            '</td>' +
                            '<td class="total-price first-row"><p class="subTotal' + index + ' subtotals">MXN $<span>' + (Number(item.quantity) * Number(price)).toFixed(2) + '</span></p></td>' +
...
function sumTotalShopping() {
    ...
    localStorage.setItem("total", hex_md5($(".valueTotalShopping").html()));
}
...
$(".btnPay").click(function () {
    ...
    var encryptTotal = localStorage.getItem("total");
    ...
    data.append("encryptTotal", encryptTotal);
    data.append("tax", tax);
